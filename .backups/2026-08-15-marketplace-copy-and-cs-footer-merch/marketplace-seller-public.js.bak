    ...
    <div class="layout">
      ...
      <div class="stack">
        <section class="panel order-panel">
          <h2>How to order</h2>
          <p>Message ${esc(sp.business_name)} directly to place an order or ask about availability — no spam, no solicitations, no offers, just direct communication regarding purchases.</p>
