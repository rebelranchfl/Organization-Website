(() => {
  ...
  header.innerHTML = `<nav class="rrm-public-nav" aria-label="Primary"><a class="rrm-public-brand" href="index.html"><img src="assets/brand/Rebel%20Ranch%20Ministries/rrm-logo-white.png" alt=""><span><strong>Rebel Ranch Ministries</strong><small>Faith &middot; Family &middot; Freedom</small></span></a><button class="rrm-public-menu" type="button" aria-expanded="false" aria-label="Open navigation">&#9776;</button><div class="rrm-public-links"><a href="index.html">Home</a><a href="merch.html">Shop</a><div class="rrm-nav-dropdown"><a href="programs.html">Programs</a><button type="button" class="rrm-nav-dropdown-toggle" aria-expanded="false" aria-label="Open Programs menu"><span class="caret">&#9662;</span></button><div class="rrm-nav-dropdown-menu"><a href="programs.html">All Programs</a><a href="index.html#business-freedom">Business Freedom</a><a href="creation.html">Creation Station</a><a href="https://academy.rebelranchministries.org">Rebel Ranch Academy</a><a href="marketplace.html">Marketplace</a><a href="programs.html#roots-boots">Roots, Boots &amp; Animal Poops</a><a href="programs.html#rescue">Rebel Ranch Rescue</a><a href="align-interest.html">Partner With Us</a></div></div><a href="support.html">Support the Mission</a><a href="account.html">My Account</a><a href="contact.html">Contact</a></div></nav>`;
