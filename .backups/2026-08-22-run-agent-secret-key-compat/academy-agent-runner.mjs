...
async function claim(){
 if(!key){console.log('SUPABASE_SERVICE_ROLE_KEY is not configured.');await writeOut('has_request','false');return}
...
async function finalize(){
 if(!key)throw new Error('SUPABASE_SERVICE_ROLE_KEY missing');const id=process.env.REQUEST_ID;if(!id)return;
